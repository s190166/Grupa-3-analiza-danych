...
```{r przygotowanie środowiska do trzyszczenia danych, include=FALSE}
...
```{r wartości odstające, include=FALSE}
# Wczytanie bibliotek
library(gridExtra)
...
```{r porownanie_total_branch, include=FALSE}
...
```{r rozklad_gross_income_customer_type, include=FALSE}
...
```{r rozklad_rating_gender, include=FALSE}
...
```{r porownanie_gross_income_gender, include=FALSE}
...
```{r porownanie_customer_type_total, include=FALSE}
...
```{r porownanie_rating_branch, include=FALSE}
...
```{r porownanie_gross_income_product_line, include=FALSE}
